...
<p> hey everyone this is my javascript mini project on a game called Simon Says </p>
<p>Simon Says is an interactive memory game built using HTML, CSS, and JavaScript. The game challenges players to remember and reproduce an increasing sequence of colors.</p>
